...
///
/// An adapter that is used for reference purposes. It is designed to showcase and test the mediation contract of the Chartboost 
/// Mediation SDK.
/// Implementations of the Chartboost Mediation mediation interface may roughly model their own design after this class, but do NOT call 
...
final class ReferenceAdapter: PartnerAdapter {
    ...
    func makeBannerAd(request: PartnerAdLoadRequest, delegate: PartnerAdDelegate) throws -> PartnerBannerAd {
        ...
        // You'll have to define your custom type that conforms to PartnerAd. Depending on how you organize your code you may have one 
        // single PartnerAdapter type, or multiple ones depending on ad format.
